...
![padding实现高度可控的分割线](blog/css/padding-margin-border/split.png)
``` css
...
![margin](blog/css/padding-margin-border/margin.png)
``` html
<div class="father">
     <div class="son"></div>
</div>
...
![margin合并](blog/css/padding-margin-border/margin-merge.gif)
...
![设置BFC](blog/css/padding-margin-border/BFC.gif)

空块级元素的 margin 合并：

![空块级元素的 margin 合并](blog/css/padding-margin-border/margin-merge-blank.png)
...
- 如果两侧均是 auto，则平分剩余空间。
  ...
  ![margin: auto](blog/css/padding-margin-border/margin-auto.png)


绝对定位可以实现水平垂直居中

![水平垂直居中](blog/css/padding-margin-border/align.png)
``` html
...
![border-color](blog/css/padding-margin-border/border-color.png)
...
![三角形](blog/css/padding-margin-border/triangle.png)
``` html
