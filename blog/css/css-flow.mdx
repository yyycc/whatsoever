...
![float实现文字环绕](https://upload-images.jianshu.io/upload_images/27409662-2aae03cae294426a.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
图片这个浮动元素塌陷，文字所在的这个块状盒子与图片是完全重叠的，又受到浮动元素的限制，没有任何重叠。

然而想象力和创造力俱佳的程序员们把float的作用在布局上发挥得淋漓尽致，但是布局是不需要父元素塌陷的，这就出现了上面那段清除浮动的代码。
![float布局](https://upload-images.jianshu.io/upload_images/27409662-2bf5fc3ea1afe3da.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![overflow: hidden实现tab切换显示](https://upload-images.jianshu.io/upload_images/27409662-6f135e34fcae008f.gif?imageMogr2/auto-orient/strip)
...
![position: absolute](https://upload-images.jianshu.io/upload_images/27409662-100e9112cb7b6f21.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
...
![direction](https://upload-images.jianshu.io/upload_images/27409662-e7bfbd753abeb176.png?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)
