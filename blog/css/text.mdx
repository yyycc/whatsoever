...
export const dataSource = [{key:1,name1:'text-indent',name2:'内联元素缩进'},{key:2,name1:'letter-spacing',name2:'字符间距'},{key:3,name1:'word-spacing',name2:'单词间距'},{key:4,name1:'text-transform',name2:'字符大小写'},{key:5,name1:':first-letter',name2:'选择第一个字符'},{key:5,name1:':first-line',name2:'选择第一行'}]
...
![ex实现垂直居中](blog/css/text/ex-align.gif)
...
![《CSS的世界》中的效果图](blog/css/text/font.png)
...
![《CSS的世界》书中的效果图](blog/css/text/word-break.png)
...
![font-weight](blog/css/text/font-weight.png)
