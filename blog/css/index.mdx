...
询问了同事小哥，得到了一个名词 - **幽灵节点** 以及一本书 - 《CSS的世界》(虽然最后发现幽灵节点在这书里只讲了一页，并且完全没能解决我的问题(<a href="/blog/css-strut/" target="_blank">后来解决啦</a>)。  
...
[css（一） 文档流](/blog/css-flow)  
[css（二） 一些基本概念](/blog/css-basic)  
[插播一则最新消息](/blog/css-strut)  
[css（三）width与height](/blog/css-height-width)  
[css（四）padding、margin、border](/blog/css-padding-margin-border)  
[css（五）层叠](/blog/css-stacking-context)  
[css（六）文本处理](/blog/css-text)  
[css（七）font-size与line-height与vertical-align](/blog/css-line-height)  
[css（八）浏览器渲染](/blog/css-browser)  
