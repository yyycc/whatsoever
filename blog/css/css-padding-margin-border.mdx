...
[css（二） 一些基本概念](https://www.whyyy.net/blog/css-basic)提到了盒子，替换元素里讲了一下content，这边我们来聊一聊剩下的三个盒子padding、margin和border
...
![padding实现高度可控的分割线](./css-padding-margin-border/split.png)
``` css
...
![margin](./css-padding-margin-border/margin.png)
``` html
<div class="father">
     <div class="son"></div>
</div>
...
![margin合并](./css-padding-margin-border/margin-merge.gif)
...
![设置BFC](./css-padding-margin-border/BFC.gif)

空块级元素的 margin 合并：

![空块级元素的 margin 合并](./css-padding-margin-border/margin-merge-blank.png)
...
- 如果两侧均是 auto，则平分剩余空间。
  ...
  ![margin: auto](./css-padding-margin-border/margin-auto.png)


绝对定位可以实现水平垂直居中

![水平垂直居中](./css-padding-margin-border/align.png)
``` html
...
![border-color](./css-padding-margin-border/border-color.png)
...
![三角形](./css-padding-margin-border/triangle.png)
``` html
